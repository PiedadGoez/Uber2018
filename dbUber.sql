...
CREATE TABLE "CUENTAS_TARJETAS" (
  ...
  PRIMARY KEY ("ID"),
  CONSTRAINT FK_EMPRESA_ID FOREIGN KEY (EMPRESA_ID) REFERENCES USUARIOS(ID) 
);
...
CREATE TABLE "USUARIOS_MEDIOS_DE_PAGOS" (
  ...
  "CUENTA_EMPRESARIAL_ID" NUMBER,
  "USUARIO_PYPAL" VARCHAR2(255),
  "EMAIL" VARCHAR2(255),
