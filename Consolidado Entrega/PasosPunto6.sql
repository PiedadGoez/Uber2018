...
CREATE TABLE "DETALLES_CONDUCTOR" (
  ...
  PRIMARY KEY ("ID"),
  CONSTRAINT FK_CONDUCTOR FOREIGN KEY (CONDUCTOR_ID) REFERENCES USUARIOS(ID)
);
...
CREATE TABLE "DETALLE_PAGOS_CONDUCTOR" (
  ...
  "VALOR" FLOAT,
  PRIMARY KEY ("ID"),
  CONSTRAINT FK_DETALLE_FACTURA_PAGO FOREIGN KEY (FACTURA_ID) REFERENCES FACTURAS(ID),  
